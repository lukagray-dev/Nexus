...
import '../dist/js/features/keyboard/keyboard';

describe('KeyboardFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="keyboard-stream"></div><button id="keyboard-btn"></button>')
    });

    feature = new window.KeyboardFeature(container);
  });
