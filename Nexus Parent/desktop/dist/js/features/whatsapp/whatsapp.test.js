...
import '../dist/js/features/whatsapp/whatsapp';
...
describe('WhatsappFeature', () => {
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="whatsapp-stream"></div><button id="whatsapp-btn"></button>')
    });

    feature = new window.WhatsappFeature(container);
  });
