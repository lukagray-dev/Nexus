...
import '../dist/js/features/gmail/gmail';

describe('GmailFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="gmail-stream"></div><button id="gmail-btn"></button>')
    });

    feature = new window.GmailFeature(container);
  });
