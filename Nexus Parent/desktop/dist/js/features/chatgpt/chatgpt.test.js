...
import '../dist/js/features/chatgpt/chatgpt';

describe('ChatgptFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="chatgpt-stream"></div><button id="chatgpt-btn"></button>')
    });

    feature = new window.ChatgptFeature(container);
  });
