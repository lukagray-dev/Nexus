...
import '../dist/js/features/instagram/instagram';

describe('InstagramFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="instagram-stream"></div><button id="instagram-btn"></button>')
    });

    feature = new window.InstagramFeature(container);
  });
