...
import '../dist/js/features/grok/grok';

describe('GrokFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="grok-stream"></div><button id="grok-btn"></button>')
    });

    feature = new window.GrokFeature(container);
  });
