...
import '../dist/js/features/notifications/notifications';
...
describe('NotificationsFeature', () => {
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="notifications-stream"></div><button id="notifications-btn"></button>')
    });

    feature = new window.NotificationsFeature(container);
  });
