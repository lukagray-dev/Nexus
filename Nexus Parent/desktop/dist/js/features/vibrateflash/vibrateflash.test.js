...
import '../dist/js/features/vibrateflash/vibrateflash';

describe('VibrateflashFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="vibrateflash-stream"></div><button id="vibrateflash-btn"></button>')
    });

    feature = new window.VibrateflashFeature(container);
  });
