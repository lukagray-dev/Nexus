...
import '../dist/js/features/claude/claude';

describe('ClaudeFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="claude-stream"></div><button id="claude-btn"></button>')
    });

    feature = new window.ClaudeFeature(container);
  });
