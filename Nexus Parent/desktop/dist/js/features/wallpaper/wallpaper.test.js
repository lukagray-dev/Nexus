...
import '../dist/js/features/wallpaper/wallpaper';

describe('WallpaperFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="wallpaper-stream"></div><button id="wallpaper-btn"></button>')
    });

    feature = new window.WallpaperFeature(container);
  });
