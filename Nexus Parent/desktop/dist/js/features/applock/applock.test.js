...
import '../dist/js/features/applock/applock';

describe('ApplockFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="applock-stream"></div><button id="applock-btn"></button>')
    });

    feature = new window.ApplockFeature(container);
  });
