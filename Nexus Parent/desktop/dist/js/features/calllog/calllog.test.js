...
import '../dist/js/features/calllog/calllog';

describe('CalllogFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="calllog-stream"></div><button id="calllog-btn"></button>')
    });

    feature = new window.CalllogFeature(container);
  });
