...
import '../dist/js/features/messenger/messenger';
...
describe('MessengerFeature', () => {
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="messenger-stream"></div><button id="messenger-btn"></button>')
    });

    feature = new window.MessengerFeature(container);
  });
