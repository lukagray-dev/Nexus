...
import '../dist/js/features/facebook/facebook';

describe('FacebookFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="facebook-stream"></div><button id="facebook-btn"></button>')
    });

    feature = new window.FacebookFeature(container);
  });
