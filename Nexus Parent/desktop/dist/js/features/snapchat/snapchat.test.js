...
import '../dist/js/features/snapchat/snapchat';

describe('SnapchatFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="snapchat-stream"></div><button id="snapchat-btn"></button>')
    });

    feature = new window.SnapchatFeature(container);
  });
