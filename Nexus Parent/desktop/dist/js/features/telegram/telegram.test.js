...
import '../dist/js/features/telegram/telegram';

describe('TelegramFeature', () => {
  let container;
  let feature;
  ...
  beforeEach(() => {
    ...
    global.fetch = vi.fn().mockResolvedValue({
      text: vi.fn().mockResolvedValue('<div id="telegram-stream"></div><button id="telegram-btn"></button>')
    });

    feature = new window.TelegramFeature(container);
  });
